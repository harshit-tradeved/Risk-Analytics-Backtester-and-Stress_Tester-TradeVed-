...
3.  **HMM Regime Upgrades:** Replace the Moving Average regime detection in `engine/regimes.py` with a multi-state Hidden Markov Model (HMM) to capture regime volatility shifts.
