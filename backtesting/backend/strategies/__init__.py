...
from backtesting.backend.strategies.rsi         import RSIStrategy
from backtesting.backend.strategies.macd        import MACDStrategy
from backtesting.backend.strategies.bollinger   import BollingerStrategy
from backtesting.backend.strategies.supertrend  import SupertrendStrategy
from backtesting.backend.strategies.donchian    import DonchianBreakoutStrategy
from backtesting.backend.strategies.macross     import MACrossStrategy

# Indicator presets — oscillators
from backtesting.backend.strategies.oscillators import (
...
from backtesting.backend.strategies.trend_indicators import (
...
from backtesting.backend.strategies.ma_variants import (
    SMACrossStrategy, WMACrossStrategy, HMACrossStrategy,
    TripleEMAStrategy, GoldenCrossStrategy,
)

# Indicator presets — volume
from backtesting.backend.strategies.volume_strats import (
    VWAPCrossStrategy, OBVTrendStrategy,
    MFIOBOSStrategy, CMFZeroStrategy,
)

# Indicator presets — breakout / volatility
from backtesting.backend.strategies.breakout_strats import (
    KeltnerBreakStrategy, ATRBreakoutStrategy, BBSqueezeStrategy,
)

# Combination (multi-indicator) strategies
from backtesting.backend.strategies.combos_rsi        import RSIMACDStrategy, RSIBBStrategy, RSIStochStrategy, RSIVolumeStrategy
from backtesting.backend.strategies.combos_macd       import MACDADXStrategy, MACDStochStrategy, MACDVolumeStrategy, MACDPSARStrategy
from backtesting.backend.strategies.combos_supertrend import STMACDStrategy, STRSIStrategy, STVolumeStrategy
from backtesting.backend.strategies.combos_multi      import (
...
# Rule builder
from backtesting.backend.strategies.custom import CustomStrategy
