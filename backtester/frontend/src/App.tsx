...
import Sidebar          from './components/backtesting/Sidebar';
import MetricsGrid      from './components/backtesting/MetricsGrid';
import ChartsPanel      from './components/backtesting/ChartsPanel';
import TradeLog         from './components/backtesting/TradeLog';
import RegimeBreakdown  from './components/backtesting/RegimeBreakdown';
import ValidationPanel  from './components/backtesting/ValidationPanel';
import StressPage       from './components/stress_testing/StressPage';
import ForwardTestPage  from './components/forward_testing/ForwardTestPage';
import ReelPage         from './components/reel_to_backtest/ReelPage';
import PipelinePage     from './components/reel_to_pipeline/PipelinePage';
