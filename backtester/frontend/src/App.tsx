...
import Sidebar          from '@backtesting/Sidebar';
import MetricsGrid      from '@backtesting/MetricsGrid';
import ChartsPanel      from '@backtesting/ChartsPanel';
import TradeLog         from '@backtesting/TradeLog';
import RegimeBreakdown  from '@backtesting/RegimeBreakdown';
import ValidationPanel  from '@backtesting/ValidationPanel';
import StressPage       from '@stress/StressPage';
import ForwardTestPage  from '@forward/ForwardTestPage';
import ReelPage         from '@reelbt/ReelPage';
import PipelinePage     from '@reelpipe/PipelinePage';
